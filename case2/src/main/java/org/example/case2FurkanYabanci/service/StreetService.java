...
public class StreetService {
    ...
    public StreetDto save(StreetSaveRequestDto streetSaveRequestDto){
        Neighborhood neighborhood = neighborhoodService.getById(streetSaveRequestDto.getNeighborhoodId());
    ...
    public StreetDto update(StreetUpdateRequestDto streetUpdateRequestDto){
        ...
        Neighborhood neighborhood = neighborhoodService.getById(streetUpdateRequestDto.getNeighborhoodId());
